...
class PokeAPI:
    ...
    def get_pokemon_data(self, species):
        """ Get api response in json format about specific pokemon by species id or name."""
    ...
    def get_pokemon_description(self, species):
        """Get api response in json format about specific pokemon species by species id or name."""
    ...
    def get_ability_data(self, ability):
        """Get api response in json format about specific ability by id or name."""
        url = f'{self.basic_url}/ability/{ability}'
        try:
            return requests.get(url).json()
        except Exception as ex:
            return ex
    ...
    def get_type_weakness(self, ptype: str):
        """Get api response in json format aboutall weaknesses of specific type."""
